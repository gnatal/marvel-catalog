        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Link
                href="/"
                className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-cyan-400"
              >
                MARVEL CATALOG
              </Link>
            </div>
      ...
      <footer className="mt-16 bg-gray-900 border-t border-fuchsia-900">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-bold text-cyan-400 mb-4 font-mono tracking-wider">
                MARVEL [NEURAL.CATALOG]
              </h3>
              <p className="text-gray-400 text-sm">
                Accessing the digital nexus of Marvels vast multiverse. Data
                streams directly from the quantum core.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-bold text-fuchsia-400 mb-4 font-mono tracking-wider">
                NAVIGATE
              </h3>
